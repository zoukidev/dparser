class dofus.Constants extends Object
{
   ...
   static var SUBVERSION = 29;
   static var SUBSUBVERSION = 1;
   static var BETAVERSION = 0;
   static var ALPHA = false;
   static var BUILD_NUMBER = 5206;
   static var VERSIONDATE = "Juillet 07 11:54:28 GMT+0100 2008";
   ...
   static var MODULES_LIST = [["scripts.swf","modules/scripts.swf",2,false,"SCRIPTS"],[dofus.Constants.MODULE_CORE,dofus.Constants.MODULE_CORE_FILE,1,false,"CORE"]];
   ...
   static function getTeamFileFromType(nType, nAlignment)
   {
      switch(nType)
      {
         case 0:
            if(nAlignment == 1)
            {
               var _loc3_ = dofus.Constants.CHALLENGE_CLIP_FILE_ANGEL;
            }
            else if(nAlignment == 2)
            {
               _loc3_ = dofus.Constants.CHALLENGE_CLIP_FILE_DEMON;
            }
            else
            {
               _loc3_ = dofus.Constants.CHALLENGE_CLIP_FILE_NORMAL;
            }
            break;
         case 1:
            if(nAlignment == 1)
            {
               _loc3_ = dofus.Constants.CHALLENGE_CLIP_FILE_ANGEL;
            }
            else if(nAlignment == 2)
            {
               _loc3_ = dofus.Constants.CHALLENGE_CLIP_FILE_DEMON;
            ...
            {
               _loc3_ = dofus.Constants.CHALLENGE_CLIP_FILE_MONSTER;
            }
            break;
         case 2:
            _loc3_ = dofus.Constants.CHALLENGE_CLIP_FILE_NORMAL;
            break;
         case 3:
            _loc3_ = dofus.Constants.CHALLENGE_CLIP_FILE_TAXCOLLECTOR;
      }
      return _loc3_;
   }
}
