   ...
   function process(sCmd, oParams)
   {
      ...
      if(sCmd.charAt(0) == "/")
      {
         ...
         switch(_loc6_)
         {
            ...
            case "ABOUT":
               var _loc7_ = "--------------------------------------------------------------\n";
               _loc7_ = _loc7_ + ("<b>DOFUS Client v" + dofus.Constants.VERSION + "." + dofus.Constants.SUBVERSION + "." + dofus.Constants.SUBSUBVERSION + "</b> (build " + dofus.Constants.BUILD_NUMBER + ")");
            ...
            case "GOD":
            case "GODMODE":
               var _loc10_ = ["Bill","Tyn","Nyx","Lichen","Simsoft"];
