   ...
   function onActions(sExtraData)
   {
      ...
      switch(_loc5_)
      {
         ...
         case 1:
            ...
            var _loc16_ = _loc14_.forceRun || this.api.datacenter.Game.isInCreaturesMode && _loc14_ instanceof dofus.datacenter.Character;
            var _loc17_ = _loc14_.forceWalk;
            var _loc18_ = !this.api.datacenter.Game.isFight?6:!(_loc14_ instanceof dofus.datacenter.Character)?4:3;
         ...
         case 2:
            ...
            else
            {
               ...
               if(_loc7_.length == 0)
               {
                  _loc11_.addAction(true,ank.utils.Timer,ank.utils.Timer.setTimer,[_loc11_,"gameactions",_loc11_,_loc11_.onActionEnd,50]);
                  _loc11_.addAction(false,this.api.ui,this.api.ui.loadUIComponent,["CenterText","CenterTextMap",{text:this.api.lang.getText("LOADING_MAP"),timer:40000},{bForceLoad:true}]);
               }
               else
               {
