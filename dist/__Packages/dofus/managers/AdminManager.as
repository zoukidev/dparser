class dofus.managers.AdminManager extends dofus.utils.ApiElement
{
   ...
   function replace(sText)
   {
      ...
      _loc3_.push({f:"%v",t:dofus.Constants.VERSION + "." + dofus.Constants.SUBVERSION + "." + dofus.Constants.SUBSUBVERSION + " build " + dofus.Constants.BUILD_NUMBER});
      var _loc4_ = 0;
